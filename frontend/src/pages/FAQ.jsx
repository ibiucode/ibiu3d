...
const FALLBACK_FAQS = [
  { question: '如何提交列印需求？', answer: '您可以透過「聯絡我們」提供需求，包含列印技術偏好、材料、尺寸及用途說明，我們會在 24 小時內回覆報價。' },
  { question: 'FDM 和 SLA 有什麼差別，應該選哪個？', answer: 'FDM 適合大尺寸、功能性零件，成本較低；SLA 適合需要高精度表面的展示品或精密零件，但尺寸較小。不確定的話在聯絡時說明用途，我們會幫您推薦。' },
    ...
    <div className="max-w-3xl mx-auto px-6 py-20">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link to="/quote" className="px-6 py-2.5 bg-orange-500 hover:bg-orange-400 text-white font-semibold rounded-lg transition-colors text-sm">上傳模型預覽</Link>
        </div>
      </div>
    </div>
  )
